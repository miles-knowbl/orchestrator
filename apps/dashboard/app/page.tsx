...
export default function LoopsPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="bg-orch-500/10 border border-orch-500/30 rounded-xl p-6 mb-8">
        <div className="flex items-start gap-4">
          <div className="w-10 h-10 rounded-lg bg-orch-500/20 flex items-center justify-center shrink-0">
            <Rocket className="w-5 h-5 text-orch-400" />
          </div>
          <div>
            <h2 className="text-lg font-semibold text-white mb-1">Start Here</h2>
            <p className="text-sm text-gray-400 mb-3">
              New to the Orchestrator? Run <code className="text-orch-400 bg-[#1a1a1a] px-1.5 py-0.5 rounded">/orchestrator-start-loop</code> in Claude Code to install and configure everything automatically.
            </p>
            <p className="text-xs text-gray-500">
              This one command clones the repo, builds it, configures MCP, and opens a Terminal window with the running server.
            </p>
          </div>
        </div>
      </div>
