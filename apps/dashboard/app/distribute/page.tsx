    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="bg-[#111] border border-[#222] rounded-xl p-6 mb-8">
        ...
        <div className="space-y-6">
          ...
          {/* Install */}
          <div>
            <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-3">Install via /orchestrator-start-loop</p>
            <p className="text-xs text-gray-500 mb-4">The <code className="text-orch-400">/orchestrator-start-loop</code> command is your single entry point. It handles all installation, configuration, and updates.</p>
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div className="w-full">
                  <p className="text-sm text-gray-300 mb-2">Download the installer command</p>
                ...
                <div className="w-full">
                  ...
                  <div className="mt-3 bg-[#0a0a0a] border border-[#222] rounded-lg px-4 py-3">
                    ...
                    <ul className="text-xs text-gray-500 space-y-1">
                      <li>&bull; Clones the orchestrator repository</li>
                ...
                <div className="w-full">
                  ...
                  <div className="bg-[#0a0a0a] border border-[#222] rounded-lg px-4 py-3">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-1.5 text-sm">
                      ...
                      <div><code className="text-orch-400">/distribution-loop</code> <span className="text-gray-500">— ship code</span></div>
                      ...
                      <div><code className="text-orch-400">/dream-loop</code> <span className="text-gray-500">— define vision</span></div>
