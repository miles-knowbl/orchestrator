...
**The audit work (reading code, analyzing architecture) does not require the server.** Only tracking calls need it. If the server is down, continue the work and catch up on tracking when it returns.
